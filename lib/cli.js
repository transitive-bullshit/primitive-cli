...
module.exports = (argv) => {
  program
    ...
    .option('-o, --output <filename>', 'Path to save generated image', String, 'out.png')
    ...
    .option('-t, --shape-type <string>', 'Type of shapes to use (rotated-ellipse, rectangle, random, etc)', String, 'triangle')
